...
//        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-KO1AUQD;Initial Catalog=22BITV02_Employee;Integrated Security=True;Trust Server Certificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Department>(entity =>
        {
            entity.HasKey(e => e.DepartmentId).HasName("PK__Departme__B2079BED0CBF45CF");
        ...
        {
            entity.HasKey(e => e.EmployeeId).HasName("PK__Employee__7AD04F11FB680588");
